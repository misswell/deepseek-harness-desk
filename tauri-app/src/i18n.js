...
const messages = {
  zh: {
    ...
    "advanced.memorySaverUnfocusDesc": "窗口失焦 60 秒后卸载 Harness 页面以释放内存；重新回到窗口时页面自动重新加载。",
  ...
  en: {
    ...
    "advanced.memorySaverUnfocusDesc": "Unload the Harness page after the window is unfocused for 60 seconds to free memory; it reloads when you return.",
