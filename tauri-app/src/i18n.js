...
const messages = {
  zh: {
    ...
    "general.dockIconVariantDesc": "选择 Dock 中显示的应用图标；退出 App 后依然生效，菜单栏图标保持不变。",
  ...
  en: {
    ...
    "general.dockIconVariantDesc": "Choose the app icon shown in the Dock; it stays after quitting, and the menu bar icon is unchanged.",
