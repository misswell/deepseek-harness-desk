...
const messages = {
  zh: {
    ...
    "general.dockIconVariant": "Dock 图标样式",
    "general.dockIconVariantDesc": "选择 Dock 中显示的应用图标；菜单栏图标保持不变。",
    "general.dockIconBlue": "蓝色",
    "general.dockIconBlack": "黑色",
    ...
    "updates.channel": "内置 dsh 更新通道",
    "updates.channelDesc": "稳定版跟随 npm 的 latest/next；预览版额外接收 alpha/beta 预览构建，可能不稳定。",
    "updates.channel.stable": "稳定版",
    "updates.channel.preview": "预览版（beta / alpha）",
    "updates.rollbackPreview": "回退到稳定版",
    "updates.rollbackTitle": "正在回退到稳定版…",
    "updates.rollbackPreparing": "正在停用预览版内置 dsh…",
    "updates.rollbackDone": "已回退到稳定版 {version}",
    "updates.rollbackFailed": "内置 dsh 回退失败",
    "updates.dsh.notManaged": "尚未安装内置 dsh，完成一键安装后可检查更新。",
    "updates.dsh.newVersion": "发现内置 dsh 新版本 {version}",
    "updates.dsh.newPreview": "发现内置 dsh 预览版 {version}",
    "updates.dsh.upToDate": "内置 dsh 已是最新版本 {version}",
    "updates.dsh.previewUpToDate": "内置 dsh 预览版已是最新（{version}）",
    "updates.dsh.previewNewerThanStable": "当前运行预览版 {current}；稳定通道最新为 {stable}",
    "updates.dsh.previewAvailable": "npm 上已有预览版 {version}，切换到“预览版”通道即可安装。",
    ...
    "advanced.memorySaverDesc": "关闭窗口到菜单栏/托盘时销毁主 WebView 以释放渲染进程内存；重新打开窗口时页面会重新加载，需要短暂等待。",
    "advanced.memorySaverUnfocus": "窗口失焦后释放页面内存",
    "advanced.memorySaverUnfocusDesc": "窗口失焦 20 秒后卸载 Harness 页面以释放内存；重新回到窗口时页面自动重新加载。",
    "advanced.memorySaverRecycle": "窗口空闲时自动回收页面内存",
    "advanced.memorySaverRecycleDesc": "窗口可见且 Harness 持续空闲（约 10 分钟无事件、无交互）时自动重新加载页面，释放渲染进程累积的内存；后端会话与历史完整保留，页面会短暂刷新。",
    "advanced.memorySaverNote": "主窗口 WebView 会在隐藏时销毁，Harness 后台服务会保持运行；重新打开窗口即可继续使用。",
  ...
  en: {
    ...
    "general.dockIconVariant": "Dock icon style",
    "general.dockIconVariantDesc": "Choose the app icon shown in the Dock; the menu bar icon stays unchanged.",
    "general.dockIconBlue": "Blue",
    "general.dockIconBlack": "Black",
    ...
    "updates.channel": "Bundled dsh update channel",
    "updates.channelDesc": "Stable follows npm latest/next; Preview also accepts alpha/beta preview builds, which may be unstable.",
    "updates.channel.stable": "Stable",
    "updates.channel.preview": "Preview (beta / alpha)",
    "updates.rollbackPreview": "Roll back to stable",
    "updates.rollbackTitle": "Rolling back to stable…",
    "updates.rollbackPreparing": "Removing the preview bundled dsh…",
    "updates.rollbackDone": "Rolled back to stable {version}",
    "updates.rollbackFailed": "Rolling back the bundled dsh failed",
    "updates.dsh.notManaged": "Bundled dsh is not installed yet; install the runtime to check for updates.",
    "updates.dsh.newVersion": "New bundled dsh version {version} available",
    "updates.dsh.newPreview": "New bundled dsh preview {version} available",
    "updates.dsh.upToDate": "Bundled dsh is up to date ({version})",
    "updates.dsh.previewUpToDate": "Bundled dsh preview is up to date ({version})",
    "updates.dsh.previewNewerThanStable": "Running preview {current}; the stable channel is at {stable}",
    "updates.dsh.previewAvailable": "npm has a preview build {version}; switch the update channel to Preview to install it.",
    ...
    "advanced.memorySaverDesc": "Destroy the main WebView when the window is hidden to release renderer memory; the page reloads when the window is reopened.",
    "advanced.memorySaverUnfocus": "Release page memory when unfocused",
    "advanced.memorySaverUnfocusDesc": "Unload the Harness page after the window is unfocused for 20 seconds to free memory; it reloads when you return.",
    "advanced.memorySaverRecycle": "Auto-recycle page memory when idle",
    "advanced.memorySaverRecycleDesc": "When the window is visible and Harness has been idle (~10 min with no events or interaction), reload the page to release memory accumulated by the renderer; backend sessions and history are fully preserved and the page refreshes briefly.",
    "advanced.memorySaverNote": "The main WebView is destroyed while hidden; the Harness backend keeps running, and reopening the window resumes it.",
    ...
    "toast.memoryRecycled": "Page memory recycled",
    ...
    "toast.dockIconBlue": "Dock icon changed to blue",
    "toast.dockIconBlack": "Dock icon changed to black",
    ...
    "toast.linkFailed": "Could not open the link in the default browser: {url}",
    "toast.linkFailed.generic": "Could not open the link in the default browser",
