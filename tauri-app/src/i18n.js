...
const messages = {
  zh: {
    ...
    "general.dockIconVariantDesc": "选择 Dock 中显示的应用图标；退出 App 后依然生效，切换时会短暂重启 Dock，菜单栏图标保持不变。",
    "general.dockIconBlue": "蓝色",
    "general.dockIconBlack": "黑色",
    "general.dockIconAvatar": "头像",
    ...
    "updates.rollbackPreparing": "正在回退到稳定版 {version}…",
    ...
    "updates.dshVersion": "内置 dsh 版本",
    "updates.dshVersionLoading": "正在读取版本列表…",
    "updates.dshApplyVersion": "切换到此版本",
    "updates.dshFollowLatest": "跟随最新版",
    "updates.dsh.pinned": "已固定到内置 dsh {version}",
    "updates.dsh.pinnedWithLatest": "已固定到 {version}；当前通道最新为 {latest}",
    "updates.dsh.pinnedHint": "已固定到 {version}，自动安装已暂停。",
    "updates.dsh.followingHint": "跟随最新版（当前 {version}）",
    "updates.dsh.npmOffline": "npm 不可达，仅列出已安装版本。",
    "updates.dsh.versionPreview": "预览",
    "updates.dsh.versionActive": "当前",
    "updates.dsh.versionInstalled": "已安装",
    "updates.dsh.versionDownload": "未安装 · 需下载",
    "updates.dshSwitchTitle": "正在切换内置 dsh…",
    "updates.dshSwitchPreparing": "正在准备内置 dsh {version}…",
    "updates.dshSwitchDone": "内置 dsh 已切换到 {version}",
    "updates.dshSwitchFailed": "切换内置 dsh 版本失败",
    "updates.dshFollowTitle": "正在跟随最新版内置 dsh…",
    "updates.dshFollowPreparing": "正在取消固定版本并重启 Harness…",
    "updates.dshFollowDone": "内置 dsh 已跟随最新版（{version}）",
    "updates.dshFollowFailed": "取消固定版本失败",
    "updates.note3": "可在「内置 dsh 版本」里切换到任意已安装版本，或从 npm 安装更早的版本降到该版本；固定版本期间不会自动安装新版本。",
    ...
    "advanced.notifyError": "任务执行失败时提醒",
    "advanced.notifyErrorDesc": "Harness 的任务出错中断时通知你。",
    "advanced.notifyDetail": "在通知中显示详细内容",
    "advanced.notifyDetailDesc": "把问题原文和报错信息写进通知。锁屏上任何人都能读到，默认关闭。",
    ...
    "toast.dockIconAvatar": "Dock 图标已切换为头像",
    "toast.dockIconNotPersisted": "图标已切换，但无法写入 App 包：退出 App 后会回到默认图标",
  ...
  en: {
    ...
    "general.dockIconVariantDesc": "Choose the app icon shown in the Dock; it stays after quitting, switching briefly restarts the Dock, and the menu bar icon is unchanged.",
    "general.dockIconBlue": "Blue",
    "general.dockIconBlack": "Black",
    "general.dockIconAvatar": "Avatar",
    ...
    "updates.rollbackPreparing": "Rolling back to stable {version}…",
    ...
    "updates.dshVersion": "Bundled dsh version",
    "updates.dshVersionLoading": "Loading the version list…",
    "updates.dshApplyVersion": "Switch to this version",
    "updates.dshFollowLatest": "Follow the newest build",
    "updates.dsh.pinned": "Pinned to bundled dsh {version}",
    "updates.dsh.pinnedWithLatest": "Pinned to {version}; the newest on this channel is {latest}",
    "updates.dsh.pinnedHint": "Pinned to {version}; automatic installs are paused.",
    "updates.dsh.followingHint": "Following the newest build (currently {version})",
    "updates.dsh.npmOffline": "npm is unreachable, so only installed versions are listed.",
    "updates.dsh.versionPreview": "preview",
    "updates.dsh.versionActive": "current",
    "updates.dsh.versionInstalled": "installed",
    "updates.dsh.versionDownload": "not installed · downloads",
    "updates.dshSwitchTitle": "Switching the bundled dsh…",
    "updates.dshSwitchPreparing": "Preparing bundled dsh {version}…",
    "updates.dshSwitchDone": "Bundled dsh switched to {version}",
    "updates.dshSwitchFailed": "Switching the bundled dsh version failed",
    "updates.dshFollowTitle": "Following the newest bundled dsh…",
    "updates.dshFollowPreparing": "Clearing the pinned version and restarting Harness…",
    "updates.dshFollowDone": "Bundled dsh now follows the newest build ({version})",
    "updates.dshFollowFailed": "Clearing the pinned version failed",
    "updates.note3": "Use “Bundled dsh version” to switch to any installed build, or install an older one from npm to downgrade; while a version is pinned no update is installed automatically.",
    ...
    "advanced.notifyError": "Notify when a task fails",
    "advanced.notifyErrorDesc": "Notify you when a Harness task ends in an error.",
    "advanced.notifyDetail": "Show details in notifications",
    "advanced.notifyDetailDesc": "Put the question text and the error message in the banner. Anyone at the lock screen can read it, so this is off by default.",
    ...
    "toast.dockIconAvatar": "Dock icon changed to avatar",
    "toast.dockIconNotPersisted": "Icon changed, but the app bundle is not writable: the default icon returns after quitting",
