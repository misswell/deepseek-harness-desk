...
final class RuntimeManager: ObservableObject {
    ...
    func checkForUpdates(
        ...
        do {
            ...
            request.setValue("DeepSeek Harness Desk/\(Bundle.main.object(forInfoDictionaryKey: "CFBundleShortVersionString") as? String ?? "0.2.22")", forHTTPHeaderField: "User-Agent")
